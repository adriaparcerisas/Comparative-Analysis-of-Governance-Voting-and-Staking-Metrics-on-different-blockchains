...
st.markdown("Staking Rewards: In addition to securing the network, staking provides participants with an economic incentive. Stakers are typically rewarded with additional tokens for their contribution to the networks operations. These rewards can vary based on factors such as the amount of tokens staked, the duration of the stake, and the networks specific rules.")
